...
$\hat{\mu}_y = \frac{1}{n}\sum_{i \in s} y_i + \frac{1}{N-n}\sum_{i \in U-s} \hat{m}(\boldsymbol{x_i})$
...
Estimator: $\hat{\mu}_y = \frac{1}{n}\sum_{i \in s} y_i + \frac{1}{N-n}\sum_{i \in U-s} \hat{m}(\boldsymbol{x_i})$
